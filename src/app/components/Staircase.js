...
//               <div
//                 key={step.id}
//                 className={`flex items-center bg-white bg-opacity-80 rounded-lg p-6 shadow-lg ${
//                   index % 2 === 0 ? "flex-row" : "flex-row-reverse"
//                 }`}
//               >
//                 {/* Step Number */}
//                 <div className="w-16 h-16 flex items-center justify-center bg-gray-200 text-gray-800 text-2xl font-bold rounded-lg">
//                   {step.id}
//                 </div>
  ...
  const Staircase = () => {
    return (
      <section className="relative py-12 px-6 text-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          {/* Section Title */}
          <h2 className="text-4xl font-semibold text-left mb-8 text-white">
            From <span className="text-blue-400">Nashik</span> Farms to Your Doorstep
          </h2>
          ...
          <div className="flex flex-col space-y-4">
            {steps.map((step, index) => (
              <div
                key={step.id}
                className={`flex items-center bg-white bg-opacity-90 rounded-lg p-6 shadow-lg ${
                  index % 2 === 0 ? "ml-0 w-4/5" : "ml-10 w-full"
                }`}
              >
                {/* Step Number */}
                <div className="w-14 h-14 flex items-center justify-center bg-gray-200 text-gray-800 text-2xl font-bold rounded-lg shadow-md">
                  {step.id}
                </div>
